...
public class TimeUtil {
     ...
     *
     * @param timeStampString 需要转换的字符串格式的时间戳
     * @param format          指定转换的格式
     * @return 转换好的日期格式
     */
    ...
    public static String getTimeDisitance(String startTime, String endTime) throws ParseException {
     ...
     * @return
     */
    public static String getDateToHM(long time) {
        return new SimpleDateFormat(FORMAT_HM_DATE).format(new Date(time));
    }
}
