 ...
 */
public class GetMyResOrderListRequest extends JavaCommonRequest{
    public GetMyResOrderListRequest(){
//        this.setMethodName("v3/orderInfo/getOrderInfoList");
        this.setMethodName("v3/orderInfo/getAppointmentOrderInfoList");
    }
