...
public final class SerializedUtils {
        //private static Log log = LogFactory.getLog(Transcoder.class);
        ...
        private static Object deserialize(byte[] in) {
            ...
            try {
                ...
                Log.i("tiger","Caught IOException decoding ");
            } catch (ClassNotFoundException e) {
                Log.i("tiger","aught CNFE decoding " + (in == null ? 0 : in.length)
                        + " bytes of data");
            } finally {
                CloseUtil.close(is);
                CloseUtil.close(bis);
        ...
        private static byte[] compress(byte[] in) {
            ...
            Log.d("tiger","Compressed " + in.length + " bytes to " + rv.length);
            return rv;
        }
        ...
        private static byte[] decompress(byte[] in) {
            ...
            if (in != null) {
                ...
                try {
                    ...
                    Log.i("tiger","Failed to decompress data");
                    bos = null;
                } finally {
                    CloseUtil.close(gis);
                    CloseUtil.close(bis);
            ...
            public static void close(Closeable closeable) {
                if (closeable != null) {
                    try {
                        ...
                        Log.i("tiger","Unable to close " + e.getMessage());
                    }
                }
            }
        }
